...
- `ExtendedNodeResult` support for averaging out powers of participants, that have been used for powerflow calculation [#168](https://github.com/ie3-institute/pypsdm/issues/168)
